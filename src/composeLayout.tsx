...
const composeLayout = (store: Store, component: React.ComponentType) => {
  ...
  /**
   * O evento `mudança de dados do dispositivo` é monitorado aqui,
   * Sempre que os dados do ponto dp mudarem, o status do ponto dp alterado será atualizado para `redux` de forma síncrona.
   * Da mesma forma, quando as informações do dispositivo mudam, o valor alterado das informações do dispositivo também será atualizado para `redux` de forma síncrona.
   */
